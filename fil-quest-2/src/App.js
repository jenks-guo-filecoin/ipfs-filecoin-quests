      ...
      <div class="content">
        ...
        <div className="nes-container">
          <div>
            ...
            <div class="item">
              <a class="nes-btn" href="https://linktr.ee" target="_blank" rel="noopener"> Go to Github</a>
              <a class="nes-btn is-primary" href="https://linktr.ee" target="_blank" rel="noopener"> Clone Repo</a>
            </div>
            <br />
        ...
        <div className="nes-container">
            ...
            <div class="item">
              <a class="nes-btn is-success" href="https://linktr.ee" target="_blank" rel="noopener"> Go to Spheron</a>
            </div>
        </div>
        <br />
        <br />
        ...
        <div className="nes-container">
            ...
            <ur class="nes-list is-disc">
              ...
              <li>Click Deploy</li>
              <br />
              <li>Wait for site deployment and visit either:y</li>
              <br />
